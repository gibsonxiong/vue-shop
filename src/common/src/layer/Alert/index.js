...
import IOSAlert from '../themes/ios/Alert';
import WeixinAlert from '../themes/weixin/Alert';
import Theme1Alert from '../themes/theme1/Alert';
...
let Alert = (options) => {
    ...
    */
    ...
    Object.assign(instance.$data.w, globalConfig);
    // 将单个 Alert instance 的配置合并到默认值中
    Object.assign(instance.$data.w, options);
    ...
    return new Promise((resolve, reject)=>{
       ...
       instance.$options.components['weixin'] = WeixinAlert;
       instance.$options.components['theme1'] = Theme1Alert;

        if(instance.$data.w.theme instanceof Object) {
            instance.$options.components['_'] = instance.$data.w.theme;
            instance.activeView = '_';            
        }else if(instance.$data.w.theme){
            instance.activeView = instance.$data.w.theme; 
        }else{
